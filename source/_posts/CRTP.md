...
以過去在軍中環境的觀察來說，OSCP 往往已被視為一個相當高的技術門檻，甚至可以說是「頂標」。在那樣的體系裡，能通過 OSCP 已經明顯高於平均水準。然而，如果放到具有實戰強度的一般乙方市場環境來看，OSCP 更像是一個起點，而不是終點。它代表的是基本滲透方法論與攻擊流程的建立，而非完整紅隊能力的成熟，如果單純以「紅隊實戰能力成長」為目標，而非證照收藏，我認為可以依照能力堆疊邏輯，規劃如下順序：
